...
resources_data = [
  ...
  # === EQUIPMENT ===
  { type: "Equipment", name: "Portable Projector", description: "BenQ 高亮度投影機（可外借）", quantity: 12, department_id: reg.id, is_active: true, advance_booking_days: 7, operating_start_slot: 16, operating_end_slot: 44, price_per_unit: 50.0, requires_approval: true, min_slots_per_booking: 1, max_slots_per_booking: 8 },
  ...
  { type: "Equipment", name: "Laptop (MacBook Pro)", description: "15吋 MacBook Pro M3（會議室借用）", quantity: 20, department_id: cse.id, is_active: true, advance_booking_days: 3, operating_start_slot: 16, operating_end_slot: 44, price_per_unit: 0.0, requires_approval: true, min_slots_per_booking: 1, max_slots_per_booking: 2 }
]
